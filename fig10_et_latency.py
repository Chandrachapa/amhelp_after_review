...
# legend
lns1 = ax1.plot(eti, latency_amhelp15k, color="black", label='AM-HELP (15k UEs)')
lns2 = ax1.plot(eti, latency_mhelp15k , color="black", marker="*", markersize=5, label='M-HELP (15k UEs)')
lns3 = ax1.plot(eti, latency_finder15k, color="black", marker="x", markersize=5, label='FINDER (15k UEs)')
